...
def main():
    ...
    #You need to write a program that, when a movie is added to the database
    #adds the movie to the DataFrame and rewrites the cosine_sim
    cosine_sim = cosine_similarity(count_matrix, count_matrix)

    index = pd.Series(df_transposed.index, index=df_transposed['Title'])["captain phillips"]
