...
def main():
    ...
    #The recommender. Basciaclly, pop the top 10 most recommended movie
    #create a string that can be read by my javascript to get each movie
    #then print each movie which can actually be read by my JS code
